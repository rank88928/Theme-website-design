...
export { check_index, Product_object_fun, execute_cart_action };
...
function execute_cart_action(action, id, num = 0) {
  ...
  if (product) {
    ...
    store_local_shopping_records("shopping_records", shopping_records); //更新儲存
...
function id_find_product_object(id) {
  shopping_records = get_local_shopping_records("shopping_records");
