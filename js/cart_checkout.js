...
import { get_local_shopping_records, store_local_shopping_records } from "./shopping/cart_records.js";
...
document.querySelector(".order-list").addEventListener("click", function (e) {
  ...
  if (target.classList.contains("plus-btn")) {
    ...
    let shopping_records = get_local_shopping_records("shopping_records");
...
function redraw_list() {
  let data = get_local_shopping_records("shopping_records");
  store_local_shopping_records(data, utils.cart_checkout_card, ".order-list");
  store_local_shopping_records(data, utils.cart_price__card, ".price-list");
